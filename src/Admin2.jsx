...
const Admin2 = ({ handleLogout }) => {
    const sendEmail = (e) => {
        e.preventDefault();
    
        // Create a pre-defined message object
        const templateParams = {
          user_name: 'Mithilesh',   // Hardcoded sender's name
          user_email: 'fusionmediaelite@gmail.com', // Predefined email
          message: 'Mithilesh log-out!', // Predefined message
        };
